...
// Defines for the Guid class and other platform dependent stuff.
  ...
  #ifdef LPGCPP_EXPORTS
    #define LPGCPP_PUBLIC __declspec(dllexport)
  #else
	#define LPGCPP_PUBLIC
  #endif

  #if defined(_MSC_VER) && !defined(__clang__)
    // clang-cl should escape this to prevent [ignored-attributes].
    namespace std {
      class LPGCPP_PUBLIC exception; // Prevents warning C4275 from MSVC.
    } // namespace std
  #endif
  ...
  #define GUID_CFUUID
  #if __GNUC__ >= 4
    #define LPGCPP_PUBLIC __attribute__ ((visibility ("default")))
  #else
    #define LPGCPP_PUBLIC
  #endif
#else
