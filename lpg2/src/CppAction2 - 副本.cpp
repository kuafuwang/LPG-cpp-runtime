                                                      ...
                                                      SymbolLookupTable &type_set)
{
    ...
    ast_buffer.Put(indentation); ast_buffer.Put("        throw UnsupportedOperationException(\"visit(\" + n->toString() + \")\");\n");
    ast_buffer.Put(indentation); ast_buffer.Put("    }\n");
                                                    ...
                                                    SymbolLookupTable &type_set)
{
    ...
    ast_buffer.Put(indentation); 
                                 ...
                                 ast_buffer.Put("\n");
    ast_buffer.Put(indentation); ast_buffer.Put("{\n");
    ast_buffer.Put(indentation); ast_buffer.Put("    virtual Object* unimplementedVisitor(const std::wstring& s);\n\n");
    {
        for (int i = 0; i < type_set.Size(); i++)
        {
            Symbol *symbol = type_set[i];
                                                      ...
                                                      SymbolLookupTable &type_set)
{
    ...
    ast_buffer.Put(indentation);
                                 ...
                                 ast_buffer.Put("\n");
    ast_buffer.Put(indentation); ast_buffer.Put("{\n");
    ast_buffer.Put(indentation); ast_buffer.Put("    virtual void unimplementedVisitor(std::wstring& s)=0;\n\n");
                                 ...
                                 const char *classname)
{
    ...
    if (option -> parent_saved)
    {
        ...
        ast_buffer.Put(indentation); ast_buffer.Put("        {\n");
        ast_buffer.Put(indentation); ast_buffer.Put("            IToken* element = list.[i];\n");
                                             ...
                                             const char *classname)
{
    ...
    if (option -> parent_saved)
    {
        ...
        ast_buffer.Put(indentation); ast_buffer.Put("    {\n");
        ast_buffer.Put(indentation); ast_buffer.Put("        return getArrayList();\n");
        ast_buffer.Put(indentation); ast_buffer.Put("    }\n\n");
    }
 ...
 /*   const char *iterDeclTemplate =
    "    class Itr implements java.util.Iterator<%%AstType%%> {\n"
...
//    ast_buffer.Put(indentation); ast_buffer.Put("    class Itr implements java.util.Iterator<");
//                                 ast_buffer.Put(option -> ast_type);
//                                 ast_buffer.Put("> {\n");
...
//
//    ast_buffer.Put(indentation); ast_buffer.Put("        bool hasNext() {\n");
...
//    ast_buffer.Put(indentation); ast_buffer.Put("        }\n");
//
//    ast_buffer.Put(indentation); ast_buffer.Put("        void remove() {\n");
//    ast_buffer.Put(indentation); ast_buffer.Put("            throw UnsupportedOperationException();\n");
//    ast_buffer.Put(indentation); ast_buffer.Put("         }\n");
//    ast_buffer.Put(indentation); ast_buffer.Put("    }\n\n");

   /* const char *listIterDeclTemplate =
    "    class ListItr extends Itr implements java.util.ListIterator<%%AstType%%> {\n"
...
//    ast_buffer.Put(indentation); ast_buffer.Put("    class ListItr extends Itr implements java.util.ListIterator<");
//                                 ast_buffer.Put(option -> ast_type);
//                                 ast_buffer.Put("> {\n");
...
//    ast_buffer.Put(indentation); ast_buffer.Put("        }\n");
//
//    ast_buffer.Put(indentation); ast_buffer.Put("        bool hasPrevious() {\n");
...
//    ast_buffer.Put(indentation); ast_buffer.Put("        }\n");
//
//    ast_buffer.Put(indentation); ast_buffer.Put("        int nextIndex() {\n");
//    ast_buffer.Put(indentation); ast_buffer.Put("            return list_itr.nextIndex();\n");
//    ast_buffer.Put(indentation); ast_buffer.Put("        }\n\n");
//
//    ast_buffer.Put(indentation); ast_buffer.Put("        int previousIndex() {\n");
...
//    ast_buffer.Put(indentation); ast_buffer.Put("        }\n");
//
//    ast_buffer.Put(indentation); ast_buffer.Put("        void add(");
//                                 ast_buffer.Put(option -> ast_type);
//                                 ast_buffer.Put(" o) {\n");
//    ast_buffer.Put(indentation); ast_buffer.Put("            throw UnsupportedOperationException();\n");
//    ast_buffer.Put(indentation); ast_buffer.Put("        }\n");
//    ast_buffer.Put(indentation); ast_buffer.Put("    }\n");
  ...
  /*  ast_buffer.Put(indentation); ast_buffer.Put("    bool isEmpty() {\n");
    ast_buffer.Put(indentation); ast_buffer.Put("        return list.isEmpty();\n");
    ast_buffer.Put(indentation); ast_buffer.Put("    }\n");
        
    ast_buffer.Put(indentation); ast_buffer.Put("    bool contains(Object o) {\n");
    ...
    ast_buffer.Put(indentation); ast_buffer.Put("    Object[] toArray() {\n");
    ast_buffer.Put(indentation); ast_buffer.Put("        return getArrayList().toArray();\n");
    ast_buffer.Put(indentation); ast_buffer.Put("    }\n");

    ast_buffer.Put(indentation); ast_buffer.Put("    <T> T[] toArray(T[] a) {\n");
    ast_buffer.Put(indentation); ast_buffer.Put("        return (T[]) getArrayList().toArray(a);\n");
    ast_buffer.Put(indentation); ast_buffer.Put("    }\n");

    ast_buffer.Put(indentation); ast_buffer.Put("    bool remove(Object o) {\n");
    ast_buffer.Put(indentation); ast_buffer.Put("        throw UnsupportedOperationException();\n");
    ast_buffer.Put(indentation); ast_buffer.Put("    }\n");

    ast_buffer.Put(indentation); ast_buffer.Put("    bool containsAll(java.util.Collection<?> c) {\n");
    ast_buffer.Put(indentation); ast_buffer.Put("        return list.containsAll(c);\n");
    ast_buffer.Put(indentation); ast_buffer.Put("    }\n");

    ast_buffer.Put(indentation); ast_buffer.Put("    bool addAll(java.util.Collection<? extends ");
                                 ast_buffer.Put(option -> ast_type);
                                 ast_buffer.Put("> c) {\n");
    ast_buffer.Put(indentation); ast_buffer.Put("        throw UnsupportedOperationException();\n");
    ast_buffer.Put(indentation); ast_buffer.Put("    }\n");

    ast_buffer.Put(indentation); ast_buffer.Put("    bool addAll(int index, java.util.Collection<? extends ");
                                 ast_buffer.Put(option -> ast_type);
                                 ast_buffer.Put("> c) {\n");
    ast_buffer.Put(indentation); ast_buffer.Put("        throw UnsupportedOperationException();\n");
    ast_buffer.Put(indentation); ast_buffer.Put("    }\n");

    ast_buffer.Put(indentation); ast_buffer.Put("    bool removeAll(java.util.Collection<?> c) {\n");
    ast_buffer.Put(indentation); ast_buffer.Put("        throw UnsupportedOperationException();\n");
    ast_buffer.Put(indentation); ast_buffer.Put("    }\n");

    ast_buffer.Put(indentation); ast_buffer.Put("    bool retainAll(java.util.Collection<?> c) {\n");
    ast_buffer.Put(indentation); ast_buffer.Put("        throw UnsupportedOperationException();\n");
    ast_buffer.Put(indentation); ast_buffer.Put("    }\n");

    ast_buffer.Put(indentation); ast_buffer.Put("    void clear() {\n");
    ast_buffer.Put(indentation); ast_buffer.Put("        throw UnsupportedOperationException();\n");
    ast_buffer.Put(indentation); ast_buffer.Put("    }\n");
    ...
    ast_buffer.Put(indentation); ast_buffer.Put("    void add(int index, ");
                                 ast_buffer.Put(option -> ast_type);
                                 ast_buffer.Put(" element) {\n");
    ast_buffer.Put(indentation); ast_buffer.Put("        throw UnsupportedOperationException();\n");
    ast_buffer.Put(indentation); ast_buffer.Put("    }\n");
    ...
    ast_buffer.Put(indentation); ast_buffer.Put("    int indexOf(Object o) {\n");
    ast_buffer.Put(indentation); ast_buffer.Put("        return getArrayList().indexOf(o);\n");
    ast_buffer.Put(indentation); ast_buffer.Put("    }\n");

    ast_buffer.Put(indentation); ast_buffer.Put("    int lastIndexOf(Object o) {\n");
    ...
    ast_buffer.Put(indentation); ast_buffer.Put("    java.util.List<");
                                 ast_buffer.Put(option -> ast_type);
