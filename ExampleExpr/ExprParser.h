    ...
    void ruleAction(int ruleNumber)
    {
        ...
        case 1: {
            setResult(
                ...
                ast_pool.data.Next() = new E(getLeftIToken(), getRightIToken(),
                    //#line 13 ExprParser.g
                    (IAst*)getRhsSym(1),
                    //#line 13 ExprParser.g
                    (IAst*)getRhsSym(3))
        ...
        case 3: {
            setResult(
                ...
                ast_pool.data.Next() = new T(getLeftIToken(), getRightIToken(),
                    //#line 15 ExprParser.g
                    (IAst*)getRhsSym(1),
                    //#line 15 ExprParser.g
                    (IAst*)getRhsSym(3))
        ...
        case 5: {
            setResult(
                ...
                ast_pool.data.Next() = new F(getRhsIToken(1))
                //#line 17 ExprParser.g
            );
            break;
        }
        ...
        case 6: {
            setResult(
                ...
                ast_pool.data.Next() = new ParenExpr(getLeftIToken(), getRightIToken(),
                    //#line 18 ExprParser.g
                    (IAst*)getRhsSym(2))
                //#line 18 ExprParser.g
            );
